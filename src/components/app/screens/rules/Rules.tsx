            ...
            <div className="space-y-6 text-white">
                ...
                <section>
                    ...
                    <ul className="list-disc ml-5 space-y-2">
                        ...
                        <li><strong>Ejemplo:</strong> El participante A: elige a Mbappe como goleador y concluye las eliminatorias con un total de 6 goles. El participante B: escoge a Morata y este finaliza con 3 goles en las eliminatorias. Por último, el participante C selecciona a C. Ronaldo y este termina con un total de 5 goles anotados. Se contará como vencedor al participante A, por escoger al jugador con mayor cantidad de goles.</li>
